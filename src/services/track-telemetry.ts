...
export const buildTrackTelemetry = (
  input: BuildTrackTelemetryInput,
): TrackTelemetry => {
  const { recording, sessionStartMs, laps, bestLapMs, nowMs, bestLapPulse } =
    input;
